...
2. Don't commit secrets; document new environment variables in `.env.example`.
3. `app/` is maintained by its original author — coordinate before refactoring.
4. Using AI coding tools is fine — any tool, any model. What matters is that
