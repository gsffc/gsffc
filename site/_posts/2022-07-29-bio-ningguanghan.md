...
{% include viddesc.html url="assets/img/news/bio/ningguanghan-3.webm" description="Dribbling / solo goals" %}

{% include viddesc.html url="assets/img/news/bio/ningguanghan-1.webm" description="Nutmegs" %}

{% include viddesc.html url="assets/img/news/bio/ningguanghan-2.webm" description="Playmaking" %}
